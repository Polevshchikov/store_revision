...
import 'core/modules/local_module.dart' as _i40;
...
import 'feature/data/repositories/revision_repository_impl.dart' as _i13;
import 'feature/data/repositories/settings_repository_impl.dart' as _i34;
import 'feature/data/repositories/user_repository_impl.dart' as _i18;
...
import 'feature/domain/repositories/revision_repository.dart' as _i12;
import 'feature/domain/repositories/settings_repository.dart' as _i33;
import 'feature/domain/repositories/user_repository.dart' as _i17;
...
import 'feature/domain/usecases/get_revisions_usecase.dart' as _i27;
import 'feature/domain/usecases/login_usecase.dart' as _i29;
import 'feature/domain/usecases/logIn_with_google_usecase.dart' as _i28;
import 'feature/domain/usecases/logout_usecase.dart' as _i30;
import 'feature/domain/usecases/singup_usecase.dart' as _i35;
import 'feature/domain/usecases/upload_camera_image_usecase.dart' as _i15;
import 'feature/domain/usecases/upload_file_usecase.dart' as _i16;
...
import 'feature/presentation/pages/home/cubit/bottom_navigation_cubit.dart'
    as _i3;
import 'feature/presentation/pages/login/cubit/login_cubit.dart' as _i38;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.ProductRepository>(
      () => _i11.ProductRepositoryImpl(get<_i7.FirebaseFirestore>()));
  gh.factory<_i12.RevisionRepository>(
      () => _i13.RevisionRepositoryImpl(get<_i7.FirebaseFirestore>()));
  await gh.factoryAsync<_i14.SharedPreferences>(() => localModule.prefs,
      preResolve: true);
  gh.factory<_i15.UploadCameraImageUseCase>(() => _i15.UploadCameraImageUseCase(
      get<_i4.FileRepository>(), get<_i9.ImagePicker>()));
  gh.factory<_i16.UploadFileUseCase>(() => _i16.UploadFileUseCase(
      get<_i4.FileRepository>(), get<_i9.ImagePicker>()));
  gh.factory<_i17.UserRepository>(() => _i18.UserRepositoryImpl(
      get<_i7.FirebaseFirestore>(), get<_i6.FirebaseAuth>()));
  gh.factory<_i19.AddTrophyCubit>(() => _i19.AddTrophyCubit(
      get<_i15.UploadCameraImageUseCase>(), get<_i16.UploadFileUseCase>()));
  gh.factory<_i20.AuthenticationRepository>(() =>
      _i21.AuthenticationRepositoryImpl(
          get<_i6.FirebaseAuth>(), get<_i7.FirebaseFirestore>()));
  gh.factory<_i22.CreateProductUseCase>(
      () => _i22.CreateProductUseCase(get<_i10.ProductRepository>()));
  gh.factory<_i23.CreateRevisionUseCase>(() => _i23.CreateRevisionUseCase(
      get<_i12.RevisionRepository>(), get<_i17.UserRepository>()));
  gh.factory<_i24.DeleteRevisionUseCase>(
      () => _i24.DeleteRevisionUseCase(get<_i12.RevisionRepository>()));
  gh.factory<_i25.GetAllUserUseCase>(
      () => _i25.GetAllUserUseCase(get<_i17.UserRepository>()));
  gh.factory<_i26.GetAuthenticatedUserUseCase>(() =>
      _i26.GetAuthenticatedUserUseCase(get<_i20.AuthenticationRepository>()));
  gh.factory<_i27.GetRevisionsUseCase>(
      () => _i27.GetRevisionsUseCase(get<_i12.RevisionRepository>()));
  gh.factory<_i28.LogInWithGoogleUseCase>(
      () => _i28.LogInWithGoogleUseCase(get<_i20.AuthenticationRepository>()));
  gh.factory<_i29.LoginUseCase>(
      () => _i29.LoginUseCase(get<_i20.AuthenticationRepository>()));
  gh.factory<_i30.LogoutUseCase>(
      () => _i30.LogoutUseCase(get<_i20.AuthenticationRepository>()));
  gh.factory<_i31.NewRevisionCubit>(
      () => _i31.NewRevisionCubit(get<_i23.CreateRevisionUseCase>()));
  gh.factory<_i32.RevisionActiveListCubit>(
      () => _i32.RevisionActiveListCubit(get<_i27.GetRevisionsUseCase>()));
  gh.factory<_i33.SettingsRepository>(
      () => _i34.SettingRepositoryImpl(get<_i14.SharedPreferences>()));
  gh.factory<_i35.SignupUseCase>(
      () => _i35.SignupUseCase(get<_i20.AuthenticationRepository>()));
  ...
  gh.factory<_i37.LanguageBloc>(
      () => _i37.LanguageBloc(get<_i33.SettingsRepository>()));
  gh.factory<_i38.LoginCubit>(() => _i38.LoginCubit(get<_i29.LoginUseCase>(),
      get<_i36.AuthenticationBloc>(), get<_i28.LogInWithGoogleUseCase>()));
  gh.factory<_i39.SignUpCubit>(() => _i39.SignUpCubit(
      get<_i35.SignupUseCase>(), get<_i36.AuthenticationBloc>()));
  return get;
}

class _$LocalModule extends _i40.LocalModule {}
