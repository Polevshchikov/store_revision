...
class TrustedAddPage extends StatefulWidget {
  const TrustedAddPage({Key? key}) : super(key: key);

  @override
  State<TrustedAddPage> createState() => _TrustedAddPageState();
}

class _TrustedAddPageState extends State<TrustedAddPage> {
  ...
  void initState() {
    ...
    _trustedAddCubit.addTrusted(trustedsId: [], revisionId: revisionId);
    super.initState();
  }
      ...
      child: Stack(
        children: [
          RefreshIndicator(
            onRefresh: () async {
              await _trustedAddCubit
                  .addTrusted(trustedsId: [], revisionId: revisionId);
            },
          ...
          Align(
            ...
            child: ButtonScreen(
              typeButton: TypeButton.add,
              onTapButtonClose: () {
                _changeBodyCubit.changeToActiveRevision();
              },
              onTapButtonCreate: () {
                _trustedAddCubit.addTrusted(
