...
@injectable
class TrustedAddUseCase
    extends UseCase<List<UserEntity>, TrustedChangedParams> {
  final RevisionRepository _revisionRepository;
  final UserRepository _userRepository;
  TrustedAddUseCase(this._revisionRepository, this._userRepository);

  @override
  Future<Either<Failure, List<UserEntity>>> call(
      TrustedChangedParams params) async {
    final resultTrusteds = await _revisionRepository.addTrustedRevision(
